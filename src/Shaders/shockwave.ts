import { ExcaliburGraphicsContextWebGL, PostProcessor, Scene, ScreenShader, Shader, vec, Vector, VertexLayout } from "excalibur";
...
export class ShockWavePostProcessor implements PostProcessor {
  ...
  initialize(graphicsContext: ExcaliburGraphicsContextWebGL): void {
    this._shader = new ScreenShader(graphicsContext, shockwaveShader);
  }
